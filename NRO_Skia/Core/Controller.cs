        ...
        try
        {
            ...
            switch (msg.command)
            {
                ...
                case -43:
                    {
                        ...
                        //Logger.Log("[OnMessage] Case -43 itemAction=" + itemAction + " info=" + info);
                        break;
                    }
                case -59:
                    {
                ...
                case 1:
                    {
                        ...
                        if (!flag9)
                        {
                            string messages = msg.reader().readUTF();
                            GameCanvas.startOKDlg(messages);
                            GameClient.SendNow(MsgType.DATA_INGAME, "Case1:" + messages);
                            Logger.Log("[OnMessage] Case1:" + messages);
                            break;
                        }
                ...
                case -107:
                    {
                        ...
                        if (Panel.isGivingItemToPet)
                        {
                            Panel.isGivingItemToPet = false;
                            return;
                        }
                ...
                case -26:
                    ...
                    GameClient.SendNow(MsgType.DATA_INGAME, "Case -26: " + message);
                    Logger.Log("[OnMessage] Case -26: " + message);
                    break;
                case -25:
                    GameCanvas.debug("SA3", 2);
                    string msg_text = msg.reader().readUTF(); // ← server gửi thông báo
                    GameScr.info1.addInfo(msg_text, 0);
                    Logger.Log("[OnMessage] Case -25: " + msg_text);
                    break;
                case 94:
                    GameCanvas.debug("SA3", 2);
                    string msg_text2 = msg.reader().readUTF(); // ← server gửi thông báo
                    GameScr.info1.addInfo(msg_text2, 0);
                    Logger.Log("[OnMessage] Case 94: " + msg_text2);
                    break;
                case 47:
                ...
                case 46:
                    ...
                    {
                        short resetX = msg.reader().readShort();
                        short resetY = msg.reader().readShort();
                        // Nếu AutoTrain đang chạy và nhân vật chưa chết thì bỏ qua RESET_POINT
                        // để tránh hiện tượng nhân vật bị giật/bay về vị trí cũ
                        if (NRO_Skia.Main.AutoTrain.AutoTrain.IsRunning && Char.myCharz().statusMe != 14)
                        {
                            
                        }
                        else
                        {
                            Char.myCharz().setResetPoint(resetX, resetY);
                        }
                    }
                    break;
                case -29:
                ...
                case 38:
                    {
                        ...
                        //Logger.Log("[OnMessage] Case 38: ID=" + num76 + " info=" + str);
                ...
                case 7:
                    {
                        ...
                        //Logger.Log("[OnMessage] Case 7 type=" + type + " info=" + info2);
                        break;
                    }
                case 6:
                    ...
                    case 0:
                        {
                            ...
                            try
                            {
                                ...
                                AutoManager.CharNameLoginSuccess(); // ← chuyển xuống đây
